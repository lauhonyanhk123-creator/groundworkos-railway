...
async function seed() {
  ...
  await db.insert(invoicesTable).values([
    { id: 'i1', invoiceNumber: `INV-${year}-021`, clientId: 'c1', jobId: 'j1', quoteId: null, subtotal: 28500, vatAmount: 5700, totalAmount: 34200, status: 'paid', issuedDate: '2026-03-01', dueDate: '2026-03-31', paidAt: new Date('2026-04-10T00:00:00Z'), notes: 'Stage 1 payment - drainage installation complete', cisDeduction: null },
    { id: 'i2', invoiceNumber: `INV-${year}-025`, clientId: 'c1', jobId: 'j1', quoteId: null, subtotal: 25000, vatAmount: 5000, totalAmount: 30000, status: 'sent', issuedDate: '2026-06-01', dueDate: '2026-07-01', paidAt: null, notes: 'Stage 2 payment - sewer connection and testing', cisDeduction: null },
    { id: 'i3', invoiceNumber: `INV-${year}-019`, clientId: 'c2', jobId: 'j2', quoteId: null, subtotal: 20000, vatAmount: 4000, totalAmount: 24000, status: 'overdue', issuedDate: '2026-04-15', dueDate: '2026-05-15', paidAt: null, notes: 'Stage 1 - excavation and blinding', cisDeduction: null },
    { id: 'i4', invoiceNumber: `INV-${year}-022`, clientId: 'c3', jobId: 'j3', quoteId: null, subtotal: 18333, vatAmount: 3667, totalAmount: 22000, status: 'paid', issuedDate: '2026-02-01', dueDate: '2026-03-01', paidAt: new Date('2026-03-20T00:00:00Z'), notes: 'Final account - all works complete', cisDeduction: null },
    { id: 'i5', invoiceNumber: `INV-${year}-024`, clientId: 'c5', jobId: 'j5', quoteId: null, subtotal: 10417, vatAmount: 2083, totalAmount: 12500, status: 'paid', issuedDate: '2026-04-01', dueDate: '2026-04-30', paidAt: new Date('2026-04-28T00:00:00Z'), notes: null, cisDeduction: null },
    { id: 'i6', invoiceNumber: `INV-${year}-026`, clientId: 'c4', jobId: 'j4', quoteId: null, subtotal: 8500, vatAmount: 1700, totalAmount: 10200, status: 'overdue', issuedDate: '2026-05-01', dueDate: '2026-05-31', paidAt: null, notes: 'Initial mobilisation and excavation works', cisDeduction: null },
  ]).onConflictDoNothing();
  ...
  await db.insert(documentsTable).values([
    ...
    { id: 'd5', name: 'RAMS - Drainage & Sewers Phase 1', type: 'rams', status: 'valid', expiryDate: null, issuedDate: '2026-02-20', relatedTo: 'job', relatedId: 'j1', relatedName: `GW-${year}-001`, notes: 'Rev 2 - approved by client 20/02/26' },
    { id: 'd6', name: 'RAMS - Utility Ducting High Street', type: 'rams', status: 'valid', expiryDate: null, issuedDate: '2026-05-01', relatedTo: 'job', relatedId: 'j4', relatedName: `GW-${year}-004`, notes: 'Includes Traffic Management Plan' },
    { id: 'd7', name: 'Street Works Permit - Utility Ducting', type: 'permit', status: 'valid', expiryDate: '2026-07-20', issuedDate: '2026-05-05', relatedTo: 'job', relatedId: 'j4', relatedName: `GW-${year}-004`, notes: 'Major Works Permit WCC-2026-1134' },
  ...
  await syncSeqCounter("jobs", [`GW-${year}-001`, `GW-${year}-002`, `GW-${year}-003`, `GW-${year}-004`, `GW-${year}-005`, `GW-${year}-006`, `GW-${year}-007`, `GW-${year}-008`]);
  await syncSeqCounter("quotes", [`QT-${year}-012`, `QT-${year}-013`, `QT-${year}-011`, `QT-${year}-009`]);
  await syncSeqCounter("invoices", [`INV-${year}-021`, `INV-${year}-025`, `INV-${year}-019`, `INV-${year}-022`, `INV-${year}-024`, `INV-${year}-026`]);
